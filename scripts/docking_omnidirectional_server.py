    ...
    def on_goal(self, goal):
        ...
        while self.mission == False:
            ...
            if abs(self.pitch_baselink_to_aruco) > 5:
                ...
                linear = 0
                perpendicular = 0
            elif abs(self.distance_x_from_baselink_to_aruco) > 0.03:
                angular = 0
                linear = 0.5 * (self.distance_y_from_baselink_to_aruco - 0.7)
                perpendicular = 2 * self.distance_x_from_baselink_to_aruco
            elif self.distance_y_from_baselink_to_aruco > 0.7:
                angular = 0
                linear = 0.5 * (self.distance_y_from_baselink_to_aruco - 0.7)
                perpendicular = 2 * self.distance_x_from_baselink_to_aruco
            else:
